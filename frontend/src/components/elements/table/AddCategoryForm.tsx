...
export const AddCategoryForm: React.FC<Props> = ({
    ...
    const handlePlusCircleClick = () => {
        ...
        setAddCategorySectionVisible(!addCategorySectionVisible);
    ...
    return (
        <React.Fragment>
            <TableRow key="tableHeader">
                <TableCell>
                    <Tooltip
                        id={!addCategorySectionVisible ? "add-row-tooltip" : "hide-row-tooltip"}
                        text={!addCategorySectionVisible ? STATIC_TEXT.ADD_ROW : STATIC_TEXT.HIDE}
                        place="right"
                        delay={2000}
                        element={
                            <IconButton
                            ...
                            >
                                {
                                    !addCategorySectionVisible ? <ControlPointIcon htmlColor="white"/> :
